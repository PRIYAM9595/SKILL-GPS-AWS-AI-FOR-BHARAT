...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate("/app/resume-upload"); // Send straight to upload page
        } catch (err) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0A0A0A]">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute bottom-0 right-[20%] w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[120px] mix-blend-screen opacity-50" />
                <div className="absolute top-0 left-[20%] w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[120px] mix-blend-screen opacity-50 animate-pulse" />
            </div>
            ...
            >
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                    ...
                    <p className="text-gray-400 mb-8 text-center">Start your career acceleration journey</p>
